...
echo "[root@rhel3 ~]# cat ../k8s_files/web-v2.yaml"
cat ../k8s_files/web-v2.yaml 

echo ""
read -p "Press any key to continue... " -n1 -s
clear

echo "[root@rhel3 ~]# kubectl apply -f ../k8s_files/web-v2.yaml -n web"
kubectl apply -f ../k8s_files/web-v2.yaml -n web
